...
2. Run sql file in /src/document/sql/Dump20180626.sql for create table and data

How to run project :

1. Clone project from https://github.com/TanPham2011/weatherManager.git
2. Import/Open project with IntelliJ IDEA
3. Wait Gradle build project
4. After finish, run WeatherManager (Spring Boot Configuration)
5. Open browser, input localhost:8081, the system will move to main page.
